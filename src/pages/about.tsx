          ...
          <div className="flex flex-col md:flex-row ">
            <div className="md:basis-2/3 order-2 md:order-1 p-6 text-foreground ">
              <p className="text-base/relaxed text-foreground/70 text-justify">
                My journey as a software developer began in 2014 when I decided
                to pursue my studies at Brawijaya University with a major in
                Computer Science. Upon delving into software developmenwqwt,
                particularly web development, I developed a strong passion to
                delve deeper into this field.
              </p>
              <p className="text-base/relaxed text-foreground/70 text-justify mt-4">
                My professional career commenced after graduating, precisely in
                2018. It has been an incredible journey, during which I have
                acquired a wealth of knowledge over the past five years.
                I&rsquo; ve traversed numerous projects and roles, each
              ...
              <p className="text-base/relaxed text-foreground/70 text-justify mt-4">
                ...
                Manager. Each of these roles has contributed uniquely to my
                skill set and provided me with diverse experiences. From
                refining the user experience as a Frontend Developer to
                overseeing entire projects as a Project Manager, I&rsquo;ve
                embraced the challenges of each position.
              </p>
            </div>
